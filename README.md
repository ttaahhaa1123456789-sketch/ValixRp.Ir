...
<title>بازی نقش Tehran | نسل بعدی بازی</title>
<!-- فونت‌های خفن -->
...
<!-- ===== NAVBAR ===== -->
<nav class="navbar">
    <div class="logo">Tehran Role Play</div>
...
<!-- ===== FOOTER ===== -->
<footer>
    <p>⚡ <span>Tehran ROLEPLAY</span> | تمامی حقوق محفوظ است © 2026</p>
</footer>
...
<script>
    ...
    // ===== TYPING EFFECT =====
    const text = "به سرور Tehran Role Play خوش آمدید، سروری جذاب و پر چالش با ایونت های هیجان انگیز";
    let i = 0;
